...
Core Deployment Concepts.......................................................................................................................2

The Build Step: From Source Code to Static Files...............................................................................2
The Deployment Step: Making Files Publicly Accessible....................................................................2
References............................................................................................................................................. 3
Building a React + Vite Project..................................................................................................................3

The package.json File............................................................................................................................3

The build script.................................................................................................................................3
The preview script............................................................................................................................4
The Build Output (dist folder)...............................................................................................................4

Purpose of the dist folder..................................................................................................................4
Minification and Transpilation.........................................................................................................5
References............................................................................................................................................. 6
Hosting on GitHub Pages...........................................................................................................................6

Deployment Methods............................................................................................................................ 6

Method 1: Deploy from a Branch.....................................................................................................6
Method 2: GitHub Actions...............................................................................................................6
The Problem with "Deploy from a Branch" for Build-Step Projects....................................................7
References............................................................................................................................................. 8
Configuring a Vite Project for GitHub Pages............................................................................................8

Updating the Vite Configuration (vite.config.js)...................................................................................8

The base option.................................................................................................................................8
Creating the GitHub Actions Workflow................................................................................................9

The .github/workflows directory......................................................................................................9
The deploy.yml file...........................................................................................................................9
References........................................................................................................................................... 10
The GitHub Actions Workflow (deploy.yml)...........................................................................................10

Anatomy of the Workflow File............................................................................................................11

name: Naming the workflow..........................................................................................................11
on: Triggering the workflow...........................................................................................................11
permissions: Granting permissions to the workflow......................................................................11
jobs: Defining the sequence of tasks..............................................................................................12
runs-on: Specifying the virtual machine.........................................................................................12
steps: The individual commands to run..........................................................................................13
Key Workflow Steps Explained..........................................................................................................13

actions/checkout: Checking out the repository code......................................................................13
actions/setup-node: Setting up the Node.js environment...............................................................14
run: npm install: Installing project dependencies...........................................................................14
run: npm run build: Running the build script.................................................................................15
actions/upload-pages-artifact: Preparing the site for deployment..................................................15
actions/deploy-pages: Deploying the site.......................................................................................15
References........................................................................................................................................... 16
Triggering and Monitoring the Deployment............................................................................................16

Pushing to GitHub to Trigger the Workflow.......................................................................................16
Viewing Workflow Progress in the "Actions" Tab..............................................................................17
Verifying the Deployed Site................................................................................................................17
References........................................................................................................................................... 17
...
_[JavaScript Build Systems](https://www.google.com/url?sa=E&q=https%3A%2F%2Fjavascript.info%2Fbuild-tools)_
_This article provides a high-level overview of why build tools like Vite are necessary in modern web_
_development, explaining concepts like transpilation, bundling, and minification._
...
## **References**
   ...
   - [React Docs: Deployment](https://www.google.com/url?sa=E&q=https%3A%2F%2Freact.dev%2Flearn%2Fdeployment)
This is the official React documentation on deployment. It covers the build process, common
hosting services, and includes specific instructions for configuring projects created with Vite for
deployment, including the base option.


   - [An Introduction to npm](https://www.google.com/url?sa=E&q=https%3A%2F%2Fjavascript.info%2Fnpm)
This resource explains the role of npm (Node Package Manager) and the package.json file in
managing project dependencies and scripts like build and preview.
...
## **References**
   ...
   - [React Docs: Deploying to GitHub Pages](https://www.google.com/url?sa=E&q=https%3A%2F%2Freact.dev%2Flearn%2Fdeployment%23deploying-to-github-pages)
This section of the React documentation provides a complete, step-by-step guide for deploying
a React application to GitHub Pages using GitHub Actions, including a full example of the
deploy.yml workflow file.


   - [YAML Syntax from DevDocs](https://www.google.com/url?sa=E&q=https%3A%2F%2Fdevdocs.io%2Fyaml%2F)
A concise reference for the YAML syntax used in GitHub Actions workflow files. It's useful for
understanding the structure, indentation, and data types.


   - [Git Basics](https://www.google.com/url?sa=E&q=https%3A%2F%2Fjavascript.info%2Fgit)

A primer on the fundamental Git commands, including git add, git commit, and git push, which
are used to trigger the deployment workflow.
...
## **References**
   ...
   -   [React Docs: Deployment](https://www.google.com/url?sa=E&q=https%3A%2F%2Freact.dev%2Flearn%2Fdeployment%23deploying-to-github-pages) GitHub Pages
This guide explains the necessity of the base configuration in vite.config.js when deploying to a
sub-path like on GitHub Pages. It also details the required folder structure (.github/workflows)
...
## **References**
   ...
   - [React Docs: Full Workflow for GitHub Pages](https://www.google.com/url?sa=E&q=https%3A%2F%2Freact.dev%2Flearn%2Fdeployment%23the-github-actions-workflow-file)
This section provides a complete, copy-paste-ready deploy.yml file. It serves as a practical
example that includes all the key sections like name, on, permissions, jobs, and the sequence of
steps needed to build and deploy a React application.


   - [YAML Syntax from DevDocs](https://www.google.com/url?sa=E&q=https%3A%2F%2Fdevdocs.io%2Fyaml%2F)
A concise reference for the YAML syntax, which is essential for correctly structuring the .yml
workflow file. It helps in understanding the indentation rules that are critical for GitHub
...
## **References**
   ...
   - [Git Basics: Pushing to a remote repository](https://www.google.com/url?sa=E&q=https%3A%2F%2Fjavascript.info%2Fgit-remote)
This article covers the git push command, which is the action that sends your local commits
(including the new workflow file) to GitHub, thereby triggering the deployment process.


   - [React Docs: Checking the result](https://www.google.com/url?sa=E&q=https%3A%2F%2Freact.dev%2Flearn%2Fdeployment%23step-4-checking-the-result)
This part of the deployment guide describes the final steps: how pushing your changes triggers
the workflow, where to monitor its progress on GitHub's "Actions" tab, and how to find the
URL of your live site in the "Pages" settings.
